...
q1 = ax1.quiver(y[0::index], x[0::index], v[0::index], u[0::index], clr_xy[0::index])
...
q3 = ax3.quiver(z[0::index], x[0::index], w[0::index], u[0::index], clr_xz[0::index])
...
ax2.quiver(z[0::index], y[0::index], x[0::index], w[0::index], v[0::index], u[0::index], length=10, normalize=True)
